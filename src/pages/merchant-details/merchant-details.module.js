...
var MerchantDetailsPageModule = (function () {
    function MerchantDetailsPageModule() {
    }
    return MerchantDetailsPageModule;
}());
MerchantDetailsPageModule = __decorate([
    NgModule({
        declarations: [
            MerchantDetailsPage,
        ],
...
export { MerchantDetailsPageModule };
//# sourceMappingURL=merchant-details.module.js.map